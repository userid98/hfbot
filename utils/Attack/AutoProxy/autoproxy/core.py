...
class AutoProxy:
    def __init__(self):
        self.ProxyDic = "/home/kali/HFBOT/HFBOT/utils/Attack/AutoProxy/autoproxy/venom/"
        self.FakePort = 4444
        self.CurrentNum=0
        self.CurrentNode = []
        self.TargetIp={}
    ...
    def Write(self,log_data):
        ...
        with open("/home/kali/HFBOT/HFBOT/utils/Attack/AutoProxy/autoproxy/log/%s"%(self.log_file), "a") as f:
    ...
    def ReadFlag(self,ip,os="windows"):
        ...
        if os == "windows":
            command = "download C:\\Users\\win7\\Desktop\\flag.txt ./flag"
